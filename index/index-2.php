    ...
    <nav id="navbar" class="fixed w-full z-50 transition-all duration-300 bg-transparent text-white text-[18px]">
        <div class="container mx-auto flex items-center justify-between py-4 px-8 md:6px">
            ...
            <div class="hidden lg:flex items-center gap-4">
                <a href="/login" class="btn-login border-2 border-white text-white font-medium px-12 py-[6px] rounded-full hover:bg-white hover:text-[#5465FF] transition">Login</a>
                <a href="/login" class="btn-register bg-white text-[#5465FF] font-medium px-12 py-[6px] rounded-full border-2 border-white hover:bg-transparent hover:text-white transition">Daftar</a>
            </div>
